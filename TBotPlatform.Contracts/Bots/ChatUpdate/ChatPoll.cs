...
public class ChatPoll(
    ...
    ChatEntity[]? explanationEntitiesOrNull,
    int? openPeriod,
    DateTime? closeDate
    )
{
    ...
    /// </summary>
    public ChatPollOption[]? OptionsOrNull { get; } = optionsOrNull;
    ...
    /// </summary>
    public ChatEntity[]? ExplanationEntitiesOrNull { get; } = explanationEntitiesOrNull;
